...
MATD::FUNC::DATA::PROCESS::Num1ToCol3::Num1ToCol3(MATD::GRAPH::Node* node) : DataPrimitiveProcess(node)
{
...
void MATD::FUNC::DATA::PROCESS::Num1ToCol3::SetSocketArguments()
{
...

	{
		...
		node->AddInputSocket("3", std::make_shared<MATD::GRAPH::InputSocket>("3", node, GetArgument("default3")));
