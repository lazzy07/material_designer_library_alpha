...
MATD::FUNC::DATA::PROCESS::Num1ToCol1::Num1ToCol1(MATD::GRAPH::Node* node) : DataPrimitiveFunction(node)
{
...

	{
		...
		node->AddInputSocket(uuid.str(), std::make_shared<MATD::GRAPH::InputSocket>(uuid.str(), node, GetArgument("2111")));
	}
...
void MATD::FUNC::DATA::PROCESS::Num1ToCol1::Update()
{
}

void MATD::FUNC::DATA::PROCESS::Num1ToCol1::OnComplete()
{
}
