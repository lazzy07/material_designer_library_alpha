...
MATD::FUNC::DATA::PROCESS::SubstractNumber::SubstractNumber(MATD::GRAPH::Node* node) : DataPrimitiveProcess(node)
{
...
void MATD::FUNC::DATA::PROCESS::SubstractNumber::Calculate()
{
	...
	MATD_CORE_TRACE("SubstractNumber values Num1: {} Num2: {} Total: {}", num1Val, num2Val, total);
