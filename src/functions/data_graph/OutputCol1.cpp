...
MATD::FUNC::DATA::OUTPUT::OutputCol1::OutputCol1(MATD::GRAPH::Node* node) : DataPrimitiveFunction(node)
{
...

	{
		...
		node->AddInputSocket(uuid.str(), std::make_shared<MATD::GRAPH::InputSocket>(uuid.str(), node, GetArgument("3011")));
	}
...
void MATD::FUNC::DATA::OUTPUT::OutputCol1::Update()
{
}

void MATD::FUNC::DATA::OUTPUT::OutputCol1::OnComplete()
{
}
